    ...
    *,
    ...
    try:
        ...
        with acquire_session_lock(session_dir):
            ...
            destination = session_dir / "artifacts" / "speaker_labels.json"
            if destination.exists():
                raise ContractError("processing_failed", "Unregistered speaker_labels.json already exists; refusing to overwrite it.")
