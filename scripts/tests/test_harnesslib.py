...
class HarnessValidationTests(unittest.TestCase):
    ...
    def test_vs_ma_23_local_direct_app_run_entrypoint_is_documented_and_guarded(self) -> None:
        ...
        self.assertIn("identifier=ma.transcriptAction.success", actions_smoke_script)
        self.assertIn("value=Transcript exported.", actions_smoke_script)
        ...
        self.assertIn("Transcript exported.", actions_smoke_script)
