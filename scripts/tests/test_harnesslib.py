...
class HarnessValidationTests(unittest.TestCase):
    ...
    def test_vs_ma_23_local_direct_app_run_entrypoint_is_documented_and_guarded(self) -> None:
        ...
        self.assertIn("~/Applications/MeetingAssistantNative.app", install_script)
        ...
        self.assertIn("AXIdentifier", smoke_script)
        self.assertIn("AXEnabled", smoke_script)
        ...
        self.assertIn("NSApplicationDelegateAdaptor(MeetingAssistantNativeAppDelegate.self)", app_source)
        ...
        self.assertIn("~/Applications/MeetingAssistantNative.app", architecture_doc)
