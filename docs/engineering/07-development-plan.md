...
| TDG-MA-004 | SwiftUI 状态、accessibility locator 和 native UI 自动化不足 | `VS-MA-12`, `VS-MA-13`, `VS-MA-16`-`VS-MA-19` | `PV-MA-001`, `PV-MA-002`, `PV-MA-007`, `PV-MA-010`, `PV-MA-011`, `PV-MA-012` | `docs/product-spec/04-user-journeys-and-ui.md`, `docs/product-spec/12-ui-ux-design.md`, `docs/engineering/03-test-strategy.md` | Swift Testing 覆盖 view model 状态，XCUITest 覆盖关键可见状态和 accessibility identifier；权限/依赖缺失、失败、降级、确认/取消均可查询 |
